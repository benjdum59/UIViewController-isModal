#
# Be sure to run `pod lib lint isModal.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = "UIViewController+isModal"
  s.version          = "1.0.2"
  s.summary          = "Determine if current UIViewController is modal"
